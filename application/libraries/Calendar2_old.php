            ...
            for ($row = 0; $row < 6; $row++) {
                ...
                for ($col = 0; $col < 7; $col++) {
                    if (isset($calendar_days[$row][$col])) {
                        ...
                        if ($down_date) {
                            if ($col == 0 || $col == 6) {
                                $calendar_html = $calendar_html . '<div style="float:left; width:14.28%; text-align:center; height:50px; line-height:50px; color:red;"><div class="day-down" data-toggle="tooltip" title="' . $down_reason . '">' . $day_number . '</div></div>';
                            } else {
                            ...
                            if ($col == 0 || $col == 6) {
                                $calendar_html = $calendar_html . '<div style="float:left; width:14.28%; text-align:center; height:50px; line-height:50px; color:red; "><div class="day-up" data-dd="' . $day_number . '" data-dm="' . $month . '" data-dy="' . $year . '" data-token="' . md5($day_number . $month . $year) . '" data-dt="' . $day_number . '-' . substr($monthName, 0, 3) . '-' . $year . '">';
                            } else {
                                $calendar_html = $calendar_html . '<div style="float:left; width:14.28%; text-align:center; height:50px; line-height:50px; color:#9e9e9e"><div class="day-up" data-dd="' . $day_number . '" data-dm="' . $month . '" data-dy="' . $year . '" data-token="' . md5($day_number . $month . $year) . '" data-dt="' . $day_number . '-' . substr($monthName, 0, 3) . '-' . $year . '">';
                            }
            ...
            for ($row = 0; $row < 6; $row++) {
                ...
                for ($col = 0; $col < 7; $col++) {
                    if (isset($calendar_days[$row][$col])) {
                        ...
                        if ($down_date) {
                            $calendar_html = $calendar_html . '<div style="float:left; width:14.28%; text-align:center; height:50px; line-height:50px; color:#9e9e9e"><div class="day-down" data-toggle="tooltip" title="' . $down_reason . '" data-dd="' . $day_number . '" data-dm="' . $month . '" data-dy="' . $year . '" data-token="' . md5($day_number . $month . $year) . '" data-dt="' . $day_number . '-' . substr($monthName, 0, 3) . '-' . $year . '">' . $day_number . '</div></div>';
                        } else {
                            $calendar_html = $calendar_html . '<div style="float:left; width:14.28%; text-align:center; height:50px; line-height:50px; color:#9e9e9e"><div class="day-up" data-dd="' . $day_number . '" data-dm="' . $month . '" data-dy="' . $year . '" data-token="' . md5($day_number . $month . $year) . '" data-dt="' . $day_number . '-' . substr($monthName, 0, 3) . '-' . $year . '">';
                            $calendar_html = $calendar_html . $day_number;
                            if ($bookings)
