...
.bootstrap-select:not([class*=col-]):not([class*=form-control]):not(.input-group-btn) {
	...
	<?php                 
		$todolistread 		= $this->rolemodel->getpermission('todo list','read');                   
		$todolistwrite 	    = $this->rolemodel->getpermission('todo list','write');                   
		$todolistdelete	    = $this->rolemodel->getpermission('todo list','delete');                   
		$todolistcreate	    = $this->rolemodel->getpermission('todo list','create');                   
		$todolistimport	    = $this->rolemodel->getpermission('todo list','import');                   
		$todolistexport 	= $this->rolemodel->getpermission('todo list','export');                   
	?> 
							...
							<div class="table-responsive todo_list">
								<table class="table table-hover table-striped table-vcenter mb-0 text-nowrap">
									...
									<tbody>
										...
										<tr>
											<td>
												<label class="custom-control custom-checkbox" <?php if($todolistwrite == '0' ){ echo 'style="pointer-events: none;"' ;}?> >
